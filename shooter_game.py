...
#фоновая музыка
mixer.init()
mixer.music.load('abck.ogg')
mixer.music.play()
fire_sound = mixer.Sound('blow.ogg')

#нам нужны такие картинки:
img_back = "amd.jpg" #фон игры
img_bullet = "ryzen.jpg" #пуля
img_hero = "am5.png" #герой
img_enemy = "aerocool.jpg" #враг
